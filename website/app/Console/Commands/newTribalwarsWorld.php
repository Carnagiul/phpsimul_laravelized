...
use App\Models\WorldBuildingRequirementBuilding;
...
class newTribalwarsWorld extends Command
{
     ...
     * @var string
     */
    protected $signature = 'phpsimul:world:newgt {worldName} {speed}';
    ...
    private function createRessources(World $world, int $speed) {
        $this->ressourceWood = new WorldRessource([
            ...
            'default_amount' => 1000,
            'default_prod' => 15 * $speed,
            'default_storage' => 1200,
        ]);
    ...
    public function createBuildings(World $world, int $speed) {
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingBarack->id;
        $requirements->required_world_building_id = $this->buildingHeadquarter->id;
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingSmithy->id;
        $requirements->required_world_building_id = $this->buildingHeadquarter->id;
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingSmithy->id;
        $requirements->required_world_building_id = $this->buildingBarack->id;
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingStable->id;
        $requirements->required_world_building_id = $this->buildingHeadquarter->id;
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingStable->id;
        $requirements->required_world_building_id = $this->buildingSmithy->id;
        $requirements->level = 5;
        $requirements->save();
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingWorkshop->id;
        $requirements->required_world_building_id = $this->buildingHeadquarter->id;
        $requirements->level = 10;
        $requirements->save();
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingMarket->id;
        $requirements->required_world_building_id = $this->buildingHeadquarter->id;
        $requirements->level = 3;
        $requirements->save();
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingMarket->id;
        $requirements->required_world_building_id = $this->buildingWarehouse->id;
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingAcademy->id;
        $requirements->required_world_building_id = $this->buildingHeadquarter->id;
        ...
        $requirements = new WorldBuildingRequirementBuilding();
        $requirements->world_building_id = $this->buildingAcademy->id;
        $requirements->required_world_building_id = $this->buildingMarket->id;
        $requirements->level = 10;
        $requirements->save();
        ...
        $this->createBuildingTimer($this->buildingWood,
            ...
            [
                'hourly' => ['initial' => 30 * $speed, 'evolution' => 1.17],
                'once' => ['initial' => 0, 'evolution' => 0]
            ],
            [
                'hourly' => ['initial' => 0, 'evolution' => 0],
    ...
    public function handle()
    {
        ...
        $speed = intval($this->argument('speed'));
        if ($speed < 1)
            $speed = 1;
        ...
        $this->createRessources($newWorld, $speed);



        $this->info('Creating new world buildings');
        $this->createBuildings($newWorld, $speed);
